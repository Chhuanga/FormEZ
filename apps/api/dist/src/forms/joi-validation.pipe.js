    ...
    transform(value) {
        if (value &&
            ...
            try {
                ...
                throw new common_1.BadRequestException('Validation failed: fields must be a valid JSON string');
            }
        }
        const validationResult = this.schema.validate(value);
        if (validationResult.error) {
            throw new common_1.BadRequestException(`Validation failed: ${validationResult.error.message}`);
        }
