...
async function main() {
  ...
  // 1. Create the Customer Feedback Form
  ...
  // 3. Create Form Submissions
  for (let i = 0; i < 150; i++) {
    const submissionDate = faker.date.recent({ days: 30 });
      ...
      data: {
        ...
        answers: {
          create: [
            ...
            // Visited Departments (Checkbox)
            {
              fieldId: 'visited_departments',
              value: faker.helpers.arrayElements(
                ['Clothing', 'Electronics', 'Home Goods', 'Groceries', 'Toys'],
              ...
              ? [
                  {
                    ...
                    value: faker.helpers.arrayElement(improvementsCorpus),
                  },
                ]
              : []),
            // New Products
              ...
              ? [
                  {
                    ...
                    value: faker.helpers.arrayElement(newProductsCorpus),
                  },
                ]
              : []),
            // Email
            ...(faker.datatype.boolean(0.3) // 30% chance of providing email
              ? [
                  {
                    fieldId: 'email',
